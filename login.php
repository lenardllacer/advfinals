<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty(trim($_POST['username']))) {
            $usernameErr = 'Please enter your desired username';
        } else {
        ...
        if (empty(trim($_POST['password']))) {
            $passwordErr = 'Please enter your desired password';
        } else {
    ...
    <body>
        <div class="wrapper">
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                ...
                <p>Don't have an account? <a href="register.php">Register here</a></p> <!-- previous content login.php -->
            </form>
        </div>
    </body>
</html>
